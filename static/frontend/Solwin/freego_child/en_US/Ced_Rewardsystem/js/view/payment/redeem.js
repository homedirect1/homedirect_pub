    ...
    function($, ko, getPaymentInformationAction, Component, totals, fullScreenLoader) {
        ...
        return Component.extend({
            ...
            apply: function() {
                ...
                var enterpoint = $('#enterpoint').val();

                var validpoint = this.totalPoint();
                $('#message').css('color','red');

                if (validpoint == defaultpoint) {
                    if(enterpoint==null || enterpoint==''){
                        $('#message').html('This is a required field.');
                        return false;
                    }
                    if(!$.isNumeric(enterpoint)){
            ...
            totalPointPlaceholder: function() {

                if (redeem.actualtotalPoint) {
                    return 'Available Points : '+ redeem.actualtotalPoint;
                } else {
                    return false;
                }
            },
